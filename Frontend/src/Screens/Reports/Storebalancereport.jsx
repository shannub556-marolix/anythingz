                    ...
                    <div className="cls_dash_main">
                        <div className="cls_store_container">
                            <div className="cls_store_left">
                                <label htmlFor="" className="cls_store_label">Store Balance Report</label>
                                ...
                                <table>
                                    <thead className='thead'>
                                        <tr>
                                            ...
                                            <th style={{ width: "15%",color:"#FFF" }}>Requested Payouts	</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Total Payable	</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Actions                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style={{ color: "orangered", fontSize: "14px" }}>V Beauty products</td>
                                            <td>₹0</td>
                                            <td>₹0</td>
                                            <td>₹0</td>
                                            <td><button className='cls_btn_blue'>View Requests</button></td>
...
export default Storebalancereport