                    ...
                    <div className="cls_dash_main">
                        <div className="cls_store_container">
                            <div className="cls_store_left">
                                <label htmlFor="" className="cls_store_label">Store Performance Report</label>
                                ...
                                <table>
                                    <thead className='thead'>
                                        <tr>
                                            ...
                                            <th style={{ width: "15%",color:"#FFF" }}>Joined Date</th>
                                            ...
                                            <th style={{ width: "15%",color:"#FFF" }}>Store Coupon Cost</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Net Earnings (Store payouts)</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Admin Commission</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Total Amount</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Average Delivery Time</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style={{ color: "orangered", fontSize: "14px" }}>London waffle co</td>
                                            <td>Oct 07, 2022</td>
                                            <td>39</td>
                                            <td>32</td>
                                            <td>71</td>
