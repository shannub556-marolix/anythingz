...
const Deliveryguyearningreport = () => {
                    ...
                    <div className="cls_dash_main">
                        <div className="cls_store_container">
                            <div className="cls_store_left">
                                <label htmlFor="" className="cls_store_label">Delivery Guy Earning Report</label>
                                ...
                                <table>
                                    <thead className='thead'>
                                        <tr>
                                            ...
                                            <th style={{ width: "15%",color:"#FFF" }}>	Delivery Earnings	</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Delivery Tip</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Tip Earnings	</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Sum Earnings	</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>40 mins</td>
                                            <td>1.00 km</td>
                                            <td><button className='cls_btn_light'>COD</button> </td>
...
export default Deliveryguyearningreport