                    ...
                    <div className="cls_dash_main">
                        <div className="cls_store_container">
                            <div className="cls_store_left">
                                <label htmlFor="" className="cls_store_label">Store-Wise Order Report</label>
                                ...
                                <table>
                                    <thead className='thead'>
                                        <tr>
                                            ...
                                            <th style={{ width: "24%",color:"#FFF" }}>Date</th>
                                            <th style={{ width: "24%",color:"#FFF" }}>Store</th>

                                            <th style={{ width: "15%",color:"#FFF" }}>Order ID</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Order Type</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Completed In</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Distance</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Payment Mode</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Paid With Wallet	</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Net Amount</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>Earnings</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	SubTotal</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Coupon Discount	</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Store Coupon Amount</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>		Store Charge</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Delivery Charge	</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Delivery Tip</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Tax Amount</th>
                                            <th style={{ width: "15%",color:"#FFF" }}>	Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Shiva Mallanna Vegetable Market</td>
                                            <td>	#OD-5376</td>
                                            <td><button className='cls_btn_light'>Delivery</button> </td>
                                            <td>40 mins</td>
                                            <td>1.00 km</td>
                                            <td><button className='cls_btn_light'>Wallet</button> </td>
...
export default Storewiseorderreport