...
const ToNonRegisteredAppUsers = () => {
      ...
      <>
               <div className="cls_block">
                             <div className="cls_notification_cont_right">
                                 <label htmlFor="" className="cls_form_out_label"> Send push notification to non registered app users </label>
  ...
  export default ToNonRegisteredAppUsers;