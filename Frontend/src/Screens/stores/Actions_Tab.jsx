    ...
    return (
      ...
      <div className="cls_block">
        <div className="cls_store_out_container">
          <label htmlFor="" className="cls_form_out_label">  Action Settings</label>

          <Form >
            <div className="cls_form_container">
           
            <div className="cls_form_div">
              <button className="cls_btn_blue">Deactivate</button>
              <button className="cls_btn_blue">Close</button>
            </div>
            <label htmlFor="" className="cls_form_div_label1">Manual intervention on Open/Close will disable Automatic Scheduling if it was previosuly enabled.</label>
