    ...
    return (
      ...
      <div className="cls_block">
        <div className="cls_store_out_container">
          <label htmlFor="" className="cls_form_out_label">  Extras</label>

          <Form >
            <div className="cls_form_container">
            <div class="cls_form_div"><label class="cls_form_div_label cls_form_div_left">Is Pure Veg?</label><div class="cls_form_div_right"><label class="switch"><input type="checkbox" /><span class="slider round" ></span></label></div></div>
            <div class="cls_form_div"><label class="cls_form_div_label cls_form_div_left">Is Featured?</label><div class="cls_form_div_right"><label class="switch"><input type="checkbox" /><span class="slider round" ></span></label></div></div>
            <div className="cls_form_div2"><label className="cls_form_div_label cls_form_div_left cls_mar_top_5px">Custom name for Featured Badge </label><div className="cls_form_div_right1"><input name="" placeholder="" type="text" className="cls_form_div_input form-control" value="" /><label htmlFor="" className="cls_form_div_label1">Leave empty to fallback to the default</label></div></div>
            
            <div class="cls_form_div"><label class="cls_form_div_label cls_form_div_left">Auto Accept Order</label><div class="cls_form_div_right"><label class="switch"><input type="checkbox" /><span class="slider round" ></span></label></div></div>
            <div class="cls_form_div"><label class="cls_form_div_label cls_form_div_left">SMS Notification for New Orders</label><div class="cls_form_div_right"><label class="switch"><input type="checkbox" /><span class="slider round" ></span></label></div></div>
            <div class="cls_form_div2"><label class="cls_form_div_label cls_form_div_left cls_mar_top_5px">Automatic Scheduling</label><div class="cls_form_div_right1"><label class="switch"><input type="checkbox" /><span class="slider round" ></span></label><label className="cls_form_div_label1">Learn more about Automatic Scheduling (Open/Close) time</label> </div></div>
            <div class="cls_form_div2"><label class="cls_form_div_label cls_form_div_left cls_mar_top_5px">Order Scheduling</label><div class="cls_form_div_right"><label class="switch"><input type="checkbox" /><span class="slider round" ></span></label><label className="cls_form_div_label1">Enabling this will allow customers to schedule their orders for future based on the store's open/close time.</label> </div></div>
